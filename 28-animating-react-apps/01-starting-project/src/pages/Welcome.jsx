...
export default function WelcomePage() {
    ...
    const opacityCity = useTransform(scrollY, [0, 300, 500], [1, 1, 0]);
    ...
    return (
        <>
            <header id="welcome-header">
                ...
                {/*    Специальный PROP style позволяет менять элемент при изменении значения, замена animate */}
                <motion.img
            ...
            <main id="welcome-content">
                ...
                <section>
                    ...
                    <p>
                        Challenges provide a framework for growth. They push boundaries, test
                        limits, and result in genuine progress. Here, we believe everyone has
